...
class _MainNavigationState extends State<MainNavigation> {
  ...
  // URL de tu Stream de Radio (Asegúrate de que sea HTTPS)
  ...
  List<Color> _getDailyGradient() {
    ...
    if (day == 5) return [const Color(0xFFFCE4EC), const Color(0xFFF8BBD0)];
            ...
            children: [
              ...
              Padding(
                ...
                child: Image.asset(
                  ...
                  height: screenHeight * 0.32, // Logo imponente
                  fit: BoxFit.contain,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        color: Colors.pink.withOpacity(0.1), blurRadius: 10)
                  ],
                ),
                child: Row(
              ...
              // --- DIVIDER CORREGIDO (Aquí estaba el error) ---
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 20),
                child: Divider(
                  indent: 60,
                  endIndent: 60,
                  color:
                      Colors.pink.withOpacity(0.2), // Solución al pinkOpacity
                ),
              ),
